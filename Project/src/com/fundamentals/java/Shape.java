 ...
 * of itself, but can provide its sub-class with data so they can have instances. Any method
...
public abstract class Shape {
	 ...
	 * accessed via their subclass instance object.
	 */
	private int length;
	private int width;
